...
if ($_SERVER['REQUEST_METHOD'] && isset($_POST['submit'])) {
    ...
    $x1 = is_numeric($_POST['coordx1']) ? $_POST['coordx1'] : 2.5;
    ...
    if ($x1 == "Error" || $x2 == "Error" || $y1 == "Error" || $y2 == "Error") {
        ...
        print('<br/>');
        print($y2);
        die("<h3 style=\"color:red;\">Los valores de x1, x2, y1 y y4 deben ser numericos</h3>");
    }
    ...
    printf("<p class=\"resp\">D = √((%f - %f)<sup>2</sup> + (%f - %f)<sup>2</sup>)</p>\n", $coord2->x, $coord1->x, $coord2->y, $coord1->y);

    printf("<p class=\"resp\">Distancia: D = " . number_format($dist, 4, '.', '.') . "</p>\n");
    ...
    <div class="contact-for">
        ...
        <div class="contact-form">
            <div class="w-100">
                <form name="frmrectangulo" id="frmrectangulo" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" novalidate>
                    ...
                    <div class="field">
                        <input type="number" name="coordy1" id="coordy1" min="0" max="1000" step=".1" placeholder="(y1)" required/>
                        <span class="entypo-base icon"></span>
