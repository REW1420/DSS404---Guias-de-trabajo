...
function error($numero, $directorio)
{
    ...
    switch ($numero):
        ...
        case 1:
            ...
            break;
        case 2:
            $htmlstr .= "borrar este directorioc/h1>\n\t";
            break;
        case 3:
...
if (isset($_GET['operacion'])):
    if (($_GET['operacion'] >= 0 && $_GET['operacion'] <= 2 && !chdir($_GET['directorio'])) || ($_GET['operacion'] = 3 && $_GET['operacion'] < 5 && !chdir($ruta))):
        error(0, ".");
    endif;
    ...
    switch ($_GET['operacion']):
        ...
        case 1:
            ...
            $htmlstr .= "<html lang=\"es\">\n";
            $htmlstr .= "<head>\n\t";
            $htmlstr .= "<title>Pägina de error</title>\n";
            $htmlstr .= "</head>\n";
            $htmlstr .= "<body>\n\t<header>\n\t\t";
        ...
        case 2:
            ...
            break;
        case 3:
            if (empty($elemento) || !existe_en_directorio($elemento) || !unlink($elemento)):
                error(3, $ruta);
            endif;
            break;
        case 4:
