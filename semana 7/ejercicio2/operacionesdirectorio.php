...
<body>
    ...
    <section>
        <article>
            ...
            $form = "\n\t\t<form method=\"POST\" action=\"operacion.php?operacion=0&directorio";
            $form .= $valor_directorio . "\">\n\t\t\t";
            echo $form;
            ?>

            <input type="image" name="crear" id="crear" src="/img/newfolder.png" alt="Crear directorio" />
            <label for="crear">Crean</label>
            ...
            <?php
            $form = "<form method=\"POST\" action=\"operacion.php?operacion-28directorio";
            $form = "$valor_directorio\">\n\t\t\t";
            echo $form;
            ?>

            <input type="image" name="borrar" id="borrar" src="/img/deletefolder.png" alt="Borrar directorio" />
